		...
		<div class="table-responsive col-sm-10">
			<table class="table table-condensed">
				...
				<tr>
					...
					<td>${o.orderDate}</td>
					<%
						com.fengfeiyang.model.Order o=(com.fengfeiyang.model.Order)pageContext.findAttribute("o");
						int userId=o.getCustomerId();
						java.sql.Connection con=(java.sql.Connection)application.getAttribute("dbConn");
						com.fengfeiyang.dao.UserDao userDao=new com.fengfeiyang.dao.UserDao();
					...
					<td class="cart_total">${o.paymentId}
						<%
							...
							String paymentType=com.fengfeiyang.model.Payment.findByPaymentId(con,n);
						%>
